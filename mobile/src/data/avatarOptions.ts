...
export const outfitColors = ['#16101E', '#FF2D9B', '#A855F7', '#D7FF1F', '#FFFFFF', '#FF8A1F', '#3DF0A0', '#FFD21F'];
export const shoeColors = ['#FFFFFF', '#FF2D9B', '#D7FF1F', '#16101E', '#FFD21F', '#A855F7'];
...
export const presetLooks: AvatarLook[] = [
  ...
  { body: 'female', skin: skinTones[0], hair: 'ponytail', hairColor: hairColors[3], top: 'tank', topColor: '#FF2D9B', bottom: 'leggings', bottomColor: '#16101E', shoeColor: '#FFFFFF', accessory: 'headband' },
  { body: 'female', skin: skinTones[4], hair: 'afro', hairColor: hairColors[0], top: 'hoodie', topColor: '#A855F7', bottom: 'shorts', bottomColor: '#16101E', shoeColor: '#D7FF1F', accessory: 'none' },
  { body: 'male', skin: skinTones[3], hair: 'short', hairColor: hairColors[0], top: 'tee', topColor: '#D7FF1F', bottom: 'shorts', bottomColor: '#16101E', shoeColor: '#FFFFFF', accessory: 'none' },
  { body: 'male', skin: skinTones[1], hair: 'curly', hairColor: hairColors[1], top: 'jacket', topColor: '#FF8A1F', bottom: 'joggers', bottomColor: '#1B1524', shoeColor: '#FF2D9B', accessory: 'shades' },
  { body: 'male', skin: skinTones[5], hair: 'buzz', hairColor: hairColors[0], top: 'hoodie', topColor: '#FF2D9B', bottom: 'joggers', bottomColor: '#16101E', shoeColor: '#FFFFFF', accessory: 'headphones' },
];
