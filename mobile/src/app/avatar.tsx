...
export default function AvatarScreen() {
  ...
  return (
    <View style={styles.root}>
      <LinearGradient colors={['#17171A', '#111113', '#060606']} style={StyleSheet.absoluteFill} />
...
const styles = StyleSheet.create({
  ...
  platform: { position: 'absolute', bottom: 0, width: 170, height: 26, borderRadius: 85, backgroundColor: 'rgba(215,255,31,0.18)', borderWidth: 1.5, borderColor: 'rgba(215,255,31,0.5)' },
  ...
  railOn: { borderColor: colors.primary, backgroundColor: 'rgba(215,255,31,0.12)' },
  ...
  optOn: { borderColor: colors.primary, backgroundColor: 'rgba(215,255,31,0.1)' },
