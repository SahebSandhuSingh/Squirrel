...
const styles = StyleSheet.create({
  ...
  gps: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(7,9,15,0.8)', borderRadius: radius.pill, paddingHorizontal: 10, paddingVertical: 6, borderWidth: 1 },
  gpsText: { fontFamily: fonts.label, fontSize: 11, letterSpacing: 0.8, textTransform: 'uppercase' },
  chip: { flexDirection: 'row', alignItems: 'center', gap: 6, alignSelf: 'flex-start', backgroundColor: 'rgba(7,9,15,0.75)', borderRadius: radius.pill, paddingHorizontal: 10, paddingVertical: 6, maxWidth: 230 },
  ...
  nowPlaying: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 12, backgroundColor: 'rgba(59,107,255,0.08)', borderRadius: radius.pill, paddingHorizontal: 12, paddingVertical: 7 },
  ...
  overlayFull: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(7,9,15,0.9)', alignItems: 'center', justifyContent: 'center', padding: 20 },
