...
export const shopItems: ShopItem[] = [
  p('h-night', 'Night Shift Hoodie', 'Outfits', 'Hoodies', 'hoodie', 1200, 'Rare', 5, '#16101E', '#D7FF1F', 'Heavyweight black hoodie with the neon tail mark.'),
  ...
  p('h-sunset', 'Sunset Hoodie', 'Outfits', 'Hoodies', 'hoodie', 2200, 'Legendary', 15, '#FF2D9B', '#FFD21F', 'Unlocked by the most consistent squirrels.'),
  p('t-neon', 'Neon Tee', 'Outfits', 'Tees', 'tee', 600, 'Common', 1, '#D7FF1F', '#FFFFFF', 'Breathable run tee.'),
  ...
  p('j-bomber', 'Afterglow Bomber', 'Outfits', 'Jackets', 'jacket', 1800, 'Epic', 12, '#A855F7', '#D7FF1F', 'Satin bomber with reflective trim.'),
  p('b-joggers', 'Cargo Joggers', 'Outfits', 'Bottoms', 'joggers', 1500, 'Rare', 6, '#1B1524', '#D7FF1F', 'Tapered joggers with zip pockets.'),
  p('b-shorts', 'Split Shorts', 'Outfits', 'Bottoms', 'shorts', 650, 'Common', 2, '#16101E', '#FF2D9B', '5" race shorts.'),
  p('s-aero', 'Aero Runners', 'Outfits', 'Shoes', 'shoes', 1000, 'Rare', 4, '#FFFFFF', '#D7FF1F', 'Light, bouncy daily trainers.'),
  ...
  p('g-pack', 'Trail Pack', 'Gear', 'Bags', 'backpack', 1300, 'Rare', 7, '#16101E', '#D7FF1F', 'Hydration-ready run pack.'),
  p('g-bottle', 'Neon Bottle', 'Gear', 'Hydration', 'bottle', 600, 'Common', 1, '#FFFFFF', '#D7FF1F', '1L insulated bottle.'),
  p('g-watch', 'Pulse Watch', 'Gear', 'Tech', 'watch', 700, 'Rare', 3, '#C9C9D6', '#D7FF1F', 'Tracks every step (in-game).'),
  ...
  p('g-mat', 'Flow Mat', 'Gear', 'Training', 'mat', 800, 'Common', 3, '#A855F7', '#16101E', 'Grippy yoga mat.'),
  p('a-shades', 'Pink Shades', 'Accessories', 'Eyewear', 'sunglasses', 400, 'Common', 1, '#D7FF1F', '#FFFFFF', 'The signature squirrel look.'),
  p('a-cap', 'Squirrel Cap', 'Accessories', 'Headwear', 'cap', 800, 'Rare', 4, '#FF4F6E', '#FFFFFF', 'Curved brim, tail logo.'),
  p('a-beanie', 'Night Beanie', 'Accessories', 'Headwear', 'beanie', 500, 'Common', 2, '#A855F7', '#D7FF1F', 'For 5 AM winter runs.'),
  p('a-band', 'Sweatband', 'Accessories', 'Headwear', 'headband', 300, 'Common', 1, '#D7FF1F', '#FFFFFF', 'Retro terry headband.'),
  p('a-socks', 'Stripe Socks', 'Accessories', 'Socks', 'socks', 250, 'Common', 1, '#FFFFFF', '#D7FF1F', 'Crew socks, double stripe.'),
