...
export const shopItems: ShopItem[] = [
  p('h-night', 'Night Shift Hoodie', 'Outfits', 'Hoodies', 'hoodie', 1200, 'Rare', 5, '#16101E', '#2F5BFF', 'Heavyweight black hoodie with the neon tail mark.'),
  p('h-cloud', 'Cloud Nine Hoodie', 'Outfits', 'Hoodies', 'hoodie', 1500, 'Epic', 10, '#F4ECF8', '#7090FF', 'Brushed fleece in cloud white. Purple drawcords.'),
  p('h-sunset', 'Sunset Hoodie', 'Outfits', 'Hoodies', 'hoodie', 2200, 'Legendary', 15, '#FF4D8D', '#FFB020', 'Unlocked by the most consistent squirrels.'),
  p('t-neon', 'Neon Tee', 'Outfits', 'Tees', 'tee', 600, 'Common', 1, '#2F5BFF', '#FFFFFF', 'Breathable run tee.'),
  ...
  p('j-bomber', 'Afterglow Bomber', 'Outfits', 'Jackets', 'jacket', 1800, 'Epic', 12, '#7090FF', '#2F5BFF', 'Satin bomber with reflective trim.'),
  p('b-joggers', 'Cargo Joggers', 'Outfits', 'Bottoms', 'joggers', 1500, 'Rare', 6, '#1B1524', '#2F5BFF', 'Tapered joggers with zip pockets.'),
  ...
  p('g-buds', 'Beat Buds', 'Gear', 'Tech', 'earbuds', 900, 'Rare', 6, '#FFFFFF', '#7090FF', 'For the one-more-km playlist.'),
  p('g-gloves', 'Grip Gloves', 'Gear', 'Training', 'gloves', 450, 'Common', 2, '#16101E', '#FFB020', 'Lifting gloves with wrist wrap.'),
  p('g-mat', 'Flow Mat', 'Gear', 'Training', 'mat', 800, 'Common', 3, '#7090FF', '#16101E', 'Grippy yoga mat.'),
  p('a-shades', 'Pink Shades', 'Accessories', 'Eyewear', 'sunglasses', 400, 'Common', 1, '#2F5BFF', '#FFFFFF', 'The signature squirrel look.'),
  p('a-cap', 'Squirrel Cap', 'Accessories', 'Headwear', 'cap', 800, 'Rare', 4, '#FF4F6E', '#FFFFFF', 'Curved brim, tail logo.'),
  p('a-beanie', 'Night Beanie', 'Accessories', 'Headwear', 'beanie', 500, 'Common', 2, '#7090FF', '#2F5BFF', 'For 5 AM winter runs.'),
  p('a-band', 'Sweatband', 'Accessories', 'Headwear', 'headband', 300, 'Common', 1, '#2F5BFF', '#FFFFFF', 'Retro terry headband.'),
  p('a-socks', 'Stripe Socks', 'Accessories', 'Socks', 'socks', 250, 'Common', 1, '#FFFFFF', '#2F5BFF', 'Crew socks, double stripe.'),
