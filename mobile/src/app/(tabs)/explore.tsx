...
function Marker({ place, active, onPress }: { place: Place; active: boolean; onPress: () => void }) {
  ...
  return (
    <Animated.View style={[styles.pinWrap, { left: `${place.x * 100}%`, top: `${27 + place.y * 46}%`, transform: [{ scale: s }] }]}>
      <Pressable onPress={onPress} style={[styles.pin, active && { borderColor: place.color, backgroundColor: 'rgba(22,22,22,0.97)' }]} accessibilityLabel={place.name}>
...
const styles = StyleSheet.create({
  top: { paddingHorizontal: 16, backgroundColor: 'rgba(10,10,10,0.55)', borderBottomLeftRadius: radius.xl, borderBottomRightRadius: radius.xl },
  ...
  pin: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(10,10,10,0.86)', borderRadius: radius.pill, padding: 4, paddingRight: 11, borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.12)', maxWidth: 170 },
  ...
  placeCard: { width: 220, flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(22,22,22,0.96)', borderRadius: radius.lg, padding: 10, borderWidth: 1.5, borderColor: colors.line },
