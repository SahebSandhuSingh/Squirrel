...
const styles = StyleSheet.create({
  ...
  xp: { flexDirection: 'row', alignItems: 'center', gap: 5, alignSelf: 'flex-start', backgroundColor: 'rgba(7,5,13,0.7)', paddingHorizontal: 10, paddingVertical: 5, borderRadius: radius.pill, marginBottom: 6 },
