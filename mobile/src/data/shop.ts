...
export const shopItems: ShopItem[] = [
  p('h-night', 'Night Shift Hoodie', 'Outfits', 'Hoodies', 'hoodie', 1200, 'Rare', 5, '#16101E', '#E3CB8F', 'Heavyweight black hoodie with the neon tail mark.'),
  p('h-cloud', 'Cloud Nine Hoodie', 'Outfits', 'Hoodies', 'hoodie', 1500, 'Epic', 10, '#F4ECF8', '#C29A6B', 'Brushed fleece in cloud white. Purple drawcords.'),
  p('h-sunset', 'Sunset Hoodie', 'Outfits', 'Hoodies', 'hoodie', 2200, 'Legendary', 15, '#E07A5F', '#E9B949', 'Unlocked by the most consistent squirrels.'),
  p('t-neon', 'Neon Tee', 'Outfits', 'Tees', 'tee', 600, 'Common', 1, '#E3CB8F', '#FFFFFF', 'Breathable run tee.'),
  p('t-cyan', 'Olive Split Tee', 'Outfits', 'Tees', 'tee', 700, 'Common', 3, '#9DB04C', '#16101E', 'Two-tone training tee.'),
  p('t-tank', 'Tempo Tank', 'Outfits', 'Tees', 'tank', 550, 'Common', 1, '#16101E', '#9DB04C', 'For hot-weather tempo runs.'),
  p('j-bomber', 'Afterglow Bomber', 'Outfits', 'Jackets', 'jacket', 1800, 'Epic', 12, '#C29A6B', '#E3CB8F', 'Satin bomber with reflective trim.'),
  p('b-joggers', 'Cargo Joggers', 'Outfits', 'Bottoms', 'joggers', 1500, 'Rare', 6, '#1B1524', '#E3CB8F', 'Tapered joggers with zip pockets.'),
  p('b-shorts', 'Split Shorts', 'Outfits', 'Bottoms', 'shorts', 650, 'Common', 2, '#16101E', '#E07A5F', '5" race shorts.'),
  p('s-aero', 'Aero Runners', 'Outfits', 'Shoes', 'shoes', 1000, 'Rare', 4, '#FFFFFF', '#E3CB8F', 'Light, bouncy daily trainers.'),
  p('s-high', 'Court Hightops', 'Outfits', 'Shoes', 'hightops', 1400, 'Epic', 9, '#16101E', '#9DB04C', 'Streetwear hightops for rest days.'),
  p('g-duffel', 'Gym Duffel', 'Gear', 'Bags', 'bag', 1200, 'Rare', 5, '#FF4F6E', '#16101E', 'Fits shoes, towel and snacks.'),
  p('g-pack', 'Trail Pack', 'Gear', 'Bags', 'backpack', 1300, 'Rare', 7, '#16101E', '#E3CB8F', 'Hydration-ready run pack.'),
  p('g-bottle', 'Neon Bottle', 'Gear', 'Hydration', 'bottle', 600, 'Common', 1, '#9DB04C', '#E3CB8F', '1L insulated bottle.'),
  p('g-watch', 'Pulse Watch', 'Gear', 'Tech', 'watch', 700, 'Rare', 3, '#C9C9D6', '#E3CB8F', 'Tracks every step (in-game).'),
  p('g-buds', 'Beat Buds', 'Gear', 'Tech', 'earbuds', 900, 'Rare', 6, '#FFFFFF', '#C29A6B', 'For the one-more-km playlist.'),
  p('g-gloves', 'Grip Gloves', 'Gear', 'Training', 'gloves', 450, 'Common', 2, '#16101E', '#E9B949', 'Lifting gloves with wrist wrap.'),
  p('g-mat', 'Flow Mat', 'Gear', 'Training', 'mat', 800, 'Common', 3, '#B4C27A', '#16101E', 'Grippy yoga mat.'),
  p('a-shades', 'Pink Shades', 'Accessories', 'Eyewear', 'sunglasses', 400, 'Common', 1, '#E3CB8F', '#9DB04C', 'The signature squirrel look.'),
  p('a-cap', 'Squirrel Cap', 'Accessories', 'Headwear', 'cap', 800, 'Rare', 4, '#FF4F6E', '#FFFFFF', 'Curved brim, tail logo.'),
  p('a-beanie', 'Night Beanie', 'Accessories', 'Headwear', 'beanie', 500, 'Common', 2, '#C29A6B', '#E3CB8F', 'For 5 AM winter runs.'),
  p('a-band', 'Sweatband', 'Accessories', 'Headwear', 'headband', 300, 'Common', 1, '#E3CB8F', '#FFFFFF', 'Retro terry headband.'),
  p('a-socks', 'Stripe Socks', 'Accessories', 'Socks', 'socks', 250, 'Common', 1, '#FFFFFF', '#E3CB8F', 'Crew socks, double stripe.'),
