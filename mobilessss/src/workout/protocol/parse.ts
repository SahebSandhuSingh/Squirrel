/* Copied from Exercise_Mechanics--main/frontend-react/src/engine/protocol.ts (only import paths changed).
   Keep in sync: every server message is validated here before the workout screen uses it. */
