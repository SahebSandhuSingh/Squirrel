...
const styles = StyleSheet.create({
  ...
  toast: { flexDirection: 'row', alignItems: 'center', gap: 10, width: '100%', maxWidth: MAX_WIDTH - 32, backgroundColor: 'rgba(22,22,22,0.97)', borderRadius: radius.md, borderWidth: 1, paddingVertical: 10, paddingHorizontal: 12, shadowColor: '#000', shadowOpacity: 0.5, shadowRadius: 16, shadowOffset: { width: 0, height: 6 }, elevation: 12 },
