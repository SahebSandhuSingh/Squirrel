...
export const shopItems: ShopItem[] = [
  p('h-night', 'Night Shift Hoodie', 'Outfits', 'Hoodies', 'hoodie', 1200, 'Rare', 5, '#16101E', '#FF7A1A', 'Heavyweight black hoodie with the neon tail mark.'),
  p('h-cloud', 'Cloud Nine Hoodie', 'Outfits', 'Hoodies', 'hoodie', 1500, 'Epic', 10, '#F4ECF8', '#7C5CFF', 'Brushed fleece in cloud white. Purple drawcords.'),
  p('h-sunset', 'Sunset Hoodie', 'Outfits', 'Hoodies', 'hoodie', 2200, 'Legendary', 15, '#FF5FA2', '#FFD23F', 'Unlocked by the most consistent squirrels.'),
  p('t-neon', 'Neon Tee', 'Outfits', 'Tees', 'tee', 600, 'Common', 1, '#FF7A1A', '#FFFFFF', 'Breathable run tee.'),
  p('t-cyan', 'Cobalt Split Tee', 'Outfits', 'Tees', 'tee', 700, 'Common', 3, '#3B6BFF', '#16101E', 'Two-tone training tee.'),
  p('t-tank', 'Tempo Tank', 'Outfits', 'Tees', 'tank', 550, 'Common', 1, '#16101E', '#3B6BFF', 'For hot-weather tempo runs.'),
  p('j-bomber', 'Afterglow Bomber', 'Outfits', 'Jackets', 'jacket', 1800, 'Epic', 12, '#7C5CFF', '#FF7A1A', 'Satin bomber with reflective trim.'),
  p('b-joggers', 'Cargo Joggers', 'Outfits', 'Bottoms', 'joggers', 1500, 'Rare', 6, '#1B1524', '#FF7A1A', 'Tapered joggers with zip pockets.'),
  p('b-shorts', 'Split Shorts', 'Outfits', 'Bottoms', 'shorts', 650, 'Common', 2, '#16101E', '#FF5FA2', '5" race shorts.'),
  p('s-aero', 'Aero Runners', 'Outfits', 'Shoes', 'shoes', 1000, 'Rare', 4, '#FFFFFF', '#FF7A1A', 'Light, bouncy daily trainers.'),
  p('s-high', 'Court Hightops', 'Outfits', 'Shoes', 'hightops', 1400, 'Epic', 9, '#16101E', '#3B6BFF', 'Streetwear hightops for rest days.'),
  p('g-duffel', 'Gym Duffel', 'Gear', 'Bags', 'bag', 1200, 'Rare', 5, '#FF4F6E', '#16101E', 'Fits shoes, towel and snacks.'),
  p('g-pack', 'Trail Pack', 'Gear', 'Bags', 'backpack', 1300, 'Rare', 7, '#16101E', '#FF7A1A', 'Hydration-ready run pack.'),
  p('g-bottle', 'Neon Bottle', 'Gear', 'Hydration', 'bottle', 600, 'Common', 1, '#3B6BFF', '#FF7A1A', '1L insulated bottle.'),
  p('g-watch', 'Pulse Watch', 'Gear', 'Tech', 'watch', 700, 'Rare', 3, '#C9C9D6', '#FF7A1A', 'Tracks every step (in-game).'),
  p('g-buds', 'Beat Buds', 'Gear', 'Tech', 'earbuds', 900, 'Rare', 6, '#FFFFFF', '#7C5CFF', 'For the one-more-km playlist.'),
  p('g-gloves', 'Grip Gloves', 'Gear', 'Training', 'gloves', 450, 'Common', 2, '#16101E', '#FFD23F', 'Lifting gloves with wrist wrap.'),
  p('g-mat', 'Flow Mat', 'Gear', 'Training', 'mat', 800, 'Common', 3, '#B69CFF', '#16101E', 'Grippy yoga mat.'),
  p('a-shades', 'Pink Shades', 'Accessories', 'Eyewear', 'sunglasses', 400, 'Common', 1, '#FF7A1A', '#3B6BFF', 'The signature squirrel look.'),
  p('a-cap', 'Squirrel Cap', 'Accessories', 'Headwear', 'cap', 800, 'Rare', 4, '#FF4F6E', '#FFFFFF', 'Curved brim, tail logo.'),
  p('a-beanie', 'Night Beanie', 'Accessories', 'Headwear', 'beanie', 500, 'Common', 2, '#7C5CFF', '#FF7A1A', 'For 5 AM winter runs.'),
  p('a-band', 'Sweatband', 'Accessories', 'Headwear', 'headband', 300, 'Common', 1, '#FF7A1A', '#FFFFFF', 'Retro terry headband.'),
  p('a-socks', 'Stripe Socks', 'Accessories', 'Socks', 'socks', 250, 'Common', 1, '#FFFFFF', '#FF7A1A', 'Crew socks, double stripe.'),
