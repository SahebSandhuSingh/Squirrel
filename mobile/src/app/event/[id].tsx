...
const styles = StyleSheet.create({
  ...
  xp: { flexDirection: 'row', alignItems: 'center', gap: 5, alignSelf: 'flex-start', backgroundColor: 'rgba(14,16,11,0.7)', paddingHorizontal: 10, paddingVertical: 5, borderRadius: radius.pill, marginBottom: 6 },
  ...
  rowIcon: { width: 40, height: 40, borderRadius: 12, backgroundColor: 'rgba(227,203,143,0.12)', alignItems: 'center', justifyContent: 'center' },
  ...
  footer: { position: 'absolute', left: 0, right: 0, bottom: 0, paddingHorizontal: 16, paddingTop: 12, backgroundColor: 'rgba(14,16,11,0.95)', borderTopWidth: 1, borderTopColor: colors.line },
});
