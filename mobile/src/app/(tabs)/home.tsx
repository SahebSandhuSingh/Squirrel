...
const styles = StyleSheet.create({
  ...
  battle: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: colors.card, borderRadius: radius.md, borderWidth: 1, borderColor: 'rgba(59,107,255,0.5)', padding: 14 },
  ...
  leaderMe: { backgroundColor: 'rgba(255,122,26,0.08)', borderRadius: radius.md, marginHorizontal: -6, paddingHorizontal: 10 },
