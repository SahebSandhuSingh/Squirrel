...
const styles = StyleSheet.create({
  ...
  heroBadge: { position: 'absolute', top: 10, left: 10, flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(7,5,13,0.7)', paddingHorizontal: 8, paddingVertical: 4, borderRadius: radius.pill },
  ...
  lock: { position: 'absolute', top: 8, right: 8, flexDirection: 'row', alignItems: 'center', gap: 2, backgroundColor: 'rgba(7,5,13,0.8)', borderRadius: radius.pill, paddingHorizontal: 6, paddingVertical: 2 },
