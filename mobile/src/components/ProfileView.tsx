...
function AccountRow() {
  ...
  return (
    <Pressable
      ...
      style={[styles.badgeRow, { marginTop: 16, borderColor: live ? 'rgba(255,122,26,0.4)' : colors.line }]}
...
const styles = StyleSheet.create({
  ...
  cityPill: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(7,5,13,0.6)', paddingHorizontal: 10, paddingVertical: 6, borderRadius: radius.pill },
