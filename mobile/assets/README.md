...
| `models/` | Four game-ready character scans for the 3D avatar preview (~0.7 MB each; pipeline in the main README) |
| `vendor/` | Vendored `@google/model-viewer` UMD build (+ licence), stored as `.txt` so Metro ships it as an asset |
