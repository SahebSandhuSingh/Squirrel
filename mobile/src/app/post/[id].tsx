...
const styles = StyleSheet.create({
  ...
  inputBar: { position: 'absolute', left: 0, right: 0, bottom: 0, paddingTop: 10, paddingHorizontal: 16, backgroundColor: 'rgba(10,10,10,0.97)', borderTopWidth: 1, borderTopColor: colors.line },
