...
const styles = StyleSheet.create({
  ...
  battle: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: colors.card, borderRadius: radius.md, borderWidth: 1, borderColor: 'rgba(157,176,76,0.5)', padding: 14 },
  ...
  leaderMe: { backgroundColor: 'rgba(227,203,143,0.08)', borderRadius: radius.md, marginHorizontal: -6, paddingHorizontal: 10 },
