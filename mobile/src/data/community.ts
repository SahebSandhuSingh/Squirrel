...
const CREW_TEMPLATES: CrewTemplate[] = [
  ...
  { name: () => 'Lifting Squirrels', members: 857, scope: 'Nearby', interest: 'gym', icon: 'weight-lifter', color: '#FFD43B', scene: 'gym', tagline: 'Strength first. Ego never.', meets: 'Mon/Wed/Fri · 7:00 PM' },
  { name: () => 'Yoga Vibes', members: 640, scope: 'Nearby', interest: 'yoga', icon: 'yoga', color: '#FF8AD8', scene: 'yoga', tagline: 'Sunset flows in the park.', meets: 'Tue & Thu · 6:30 PM' },
  { name: () => 'No Sugar Club', members: 412, scope: 'Online', interest: 'nutrition', icon: 'food-apple', color: '#35DFFF', scene: 'brunch', tagline: '30-day no-sugar challenges & recipes.', meets: 'Daily check-ins' },
  { name: () => 'Early Birds', members: 1100, scope: 'Nearby', interest: 'running', icon: 'weather-sunset-up', color: '#FF7A45', scene: 'lake', tagline: 'Up before the sun. Every day.', meets: 'Daily · 5:30 AM' },
  { name: (c) => `${c.name} Night Riders`, members: 530, scope: 'Nearby', interest: 'cycling', icon: 'bike', color: '#B57BFF', scene: 'cycling', tagline: 'City loops after dark, lights on.', meets: 'Fri · 9:00 PM' },
  { name: () => 'Campus Sweat Society', members: 318, scope: 'Campus', interest: 'hiit', icon: 'lightning-bolt', color: '#FF35B5', scene: 'hiit', tagline: 'Between-lecture HIIT and track days.', meets: 'Mon–Fri · 4:30 PM' },
  ...
  { name: (c) => `${c.name} Rooftop Stretch`, members: 275, scope: 'Nearby', interest: 'yoga', icon: 'human-handsup', color: '#FFD43B', scene: 'rooftop', tagline: 'Mobility + city views.', meets: 'Sun · 7:00 PM' },
];
