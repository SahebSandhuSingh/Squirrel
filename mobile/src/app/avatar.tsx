...
export default function AvatarScreen() {
  ...
  return (
    <View style={styles.root}>
      <LinearGradient colors={['#1F1F1F', '#111111', '#0A0A0A']} style={StyleSheet.absoluteFill} />
...
const styles = StyleSheet.create({
  ...
  platform: { position: 'absolute', bottom: 0, width: 170, height: 26, borderRadius: 85, backgroundColor: 'rgba(255,107,0,0.18)', borderWidth: 1.5, borderColor: 'rgba(255,107,0,0.5)' },
  ...
  railOn: { borderColor: colors.primary, backgroundColor: 'rgba(255,107,0,0.12)' },
  railText: { color: colors.sub, fontSize: 10, fontFamily: fonts.semibold },
  panel: { marginTop: 14, paddingBottom: 14, paddingLeft: 16, paddingTop: 12, borderTopWidth: 1, borderTopColor: colors.line, backgroundColor: 'rgba(17,17,17,0.6)' },
  ...
  optOn: { borderColor: colors.primary, backgroundColor: 'rgba(255,107,0,0.1)' },
